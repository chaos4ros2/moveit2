...
class MoveGroupPythonIntefaceTutorial(Node):
  ...
  def __init__(self):
    ...
    display_trajectory_publisher = self.create_subscription(moveit_msgs.msg.DisplayTrajectory,
  ...
  def wait_for_state_update(self, box_is_known=False, box_is_attached=False, timeout=4):
    ...
    ##########################################################################    
      ...
      rate = self.create_rate(10) # 10Hz = 0.1s
      rate.sleep()
      seconds = self.get_clock().now()
      #########################################################################
